...
class ActivityInicio : AppCompatActivity() {
    ...
    private fun formatearPesos(valor: Double): String {
        ...
        return when {
            ...
            valor >= 1_000_000 ->
                String.format("$%.1f M", valor / 1_000_000)
    ...
    private fun cargarResumen() {
        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                val response =
                    RetrofitClient.instance.dashboardAndroid("Bearer $token")
    ...
    private fun cargarGraficaMovimientos() {
        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                val response =
                    RetrofitClient.instance.getMovimientosSemanales("Bearer $token")
                ...
                if (response.isSuccessful) {
                    ...
                    response.body()?.let { lista ->
                        ...
                        setEntradas.color = Color.parseColor("#1D4ED8") // Azul oscuro

                        val setSalidas = BarDataSet(salidas, "Salidas")
                        setSalidas.color = Color.parseColor("#3B82F6") // Azul medio
                        val data =
                            BarData(setEntradas, setSalidas)
    ...
    private fun cargarGraficaCategorias() {
        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                val response =
                    RetrofitClient.instance.getCategoriasGrafica("Bearer $token")
